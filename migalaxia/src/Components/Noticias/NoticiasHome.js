...
function NoticiasHome(props) {
    const atras = props.atras;

    return (
        <div id='noticias'>
        <h1 className='titulo'>Noticias</h1>
        <div className='row mx-2'>
        <NoticiaPreview atras={atras} noticia={new Noticia(1, "Cada vez estamos más cerca del sol", "sistemaSolar.jpg", "El sol",
            [{titulo:"Titulo 1", contenido:"Hola, me llamo Inbal\nAdios."}]
        )}/>
        <NoticiaPreview atras={atras} noticia={new Noticia(2, "La NASA reconsidera su plan para traer muestras poco comunes de Marte a la Tierra",
